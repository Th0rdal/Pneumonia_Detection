...
acgan = Acgan(eta=0.0001, batch_size=64, epochs=500, weight_decay=6e-9, latent_space=200, image_shape=(180, 180, 3), kernel_size=5) #epoch: 500, batch_size: 64
...
G = tf.keras.models.load_model(os.path.join(os.getcwd(), 'resources/model/cGAN/generator2.h5'))
#------------------------------ GENERIEREN von Bildern, mit dem Model ------------------------------

datasetGenerationSize = 500 #500
...
img_path = 'input/chest_xray/val/NORMAL/NORMAL2-IM-1427-0001.jpeg'


img_array = GradCAM.get_img_array(img_path, size=(180, 180))
last_conv_layer_name = "block5_conv3"
classifier_layer_names = ["dense", "batch_normalization", "leaky_re_lu", "dropout", "dense_1"]

heatmap = GradCAM.make_gradcam_heatmap(img_array, m, last_conv_layer_name, classifier_layer_names)
